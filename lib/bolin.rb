...
module Bolin
  ...
  class Callback
    SUCCESS = [200, {'Content-Type' => 'text/plain'.freeze, 'Content-Length' => 2}.freeze, 'OK'.freeze].freeze
    FAILURE = [470, {'Content-Type' => 'text/plain'.freeze, 'Content-Length' => 2}.freeze, 'NG'.freeze].freeze
